...
class ArraySortedList(SortedList[T]):
    ...
    def reverse_order(self) -> T:
        """
            ...
            PARAMETERS:
            Object instantiated from ArraySortedList or its subclasses
            ...____...___...___...___...____...___...___...___...____...___...___...___...____...___...___...
            METHOD DESCRIPTION:
            Reverses the order of the list.
            Eg: [1,2,3,4,5] when reversed will become [5,4,3,2,1]
            ...____...___...___...___...____...___...___...___...____...___...___...___...____...___...___...
            RETURN:
            reverse_sorted_list[T]: the object but reversed.
            ...____...___...___...___...____...___...___...___...____...___...___...___...____...___...___...
            COMPLEXITY FOR BEST CASE:
            O(1), where list is empty.
            O(n), where n is the length of the list.
        """
        reverse_sorted_list = ArraySortedList(self.length)
        i = 0
        while not self.is_empty():
            item_to_add = self.delete_at_index((self.length) - 1)
            reverse_sorted_list.add(ListItem(item_to_add, i))
            i += 1
